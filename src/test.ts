...
if (!noSessionResult.ok) {
  ...
  assert.match(noSessionResult.payload.first_call_prompt as string, /frankfurter/);
  assert.doesNotMatch(noSessionResult.payload.first_call_prompt as string, /fixer_latest|brave_search/);
