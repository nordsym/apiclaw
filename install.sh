...
echo -e "${DIM}MCP/CLI first_run prints a live https://apiclaw.cloud/auth/cli?authId= URL.${NC}"
echo -e "${DIM}Show that URL. Do not only print the login command.${NC}"
echo -e "${DIM}Finish Google or email on that URL — that Authorizes (one action).${NC}"
