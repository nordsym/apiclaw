...
const MANAGED_PROVIDERS: ApiEntry[] = [
  ...
  { name: "Resend", description: "Email API for developers. Send transactional and marketing emails with high deliverability.", category: "Communication", baseUrl: "https://api.resend.com", docsUrl: "https://resend.com/docs", auth: "managed", pricing: "freemium", callable: true },
  ...
  { name: "46elks", description: "SMS, MMS and voice calls API. Send and receive messages programmatically.", category: "Communication", baseUrl: "https://api.46elks.com", docsUrl: "https://46elks.com/docs", auth: "managed", pricing: "paid", callable: true },
  { name: "Twilio", description: "Cloud communications platform. SMS, voice, video, and authentication APIs.", category: "Communication", baseUrl: "https://api.twilio.com", docsUrl: "https://www.twilio.com/docs", auth: "managed", pricing: "paid", callable: true },
