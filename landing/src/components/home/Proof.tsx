          ...
          <div className="mt-20 grid gap-10 lg:grid-cols-[minmax(0,0.9fr)_minmax(0,1.1fr)] lg:gap-16">
            <div>
              ...
              <p className="mt-3 text-[15px] leading-[1.65] text-text-secondary">
                Free APIs are free forever. Paid APIs bill provider cost plus {PAYG_MARGIN_PERCENT}% after you add a card. Or bring your own key and route calls through it for free, no card.
              </p>
