 ...
 * writes src/workspace-public-apis.generated.ts.
 */
...
const OUTPUT = resolve(ROOT, "src/workspace-public-apis.generated.ts");
 ...
 * Do not edit by hand. Workspace-authenticated public / no-key origins only.
 */
...
export const WORKSPACE_PUBLIC_APIS = ${JSON.stringify(allowlist, null, 2)} as const satisfies readonly WorkspacePublicApi[];
`;
